...
public class GrayFlareItem extends Item {
    public GrayFlareItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if (!pLevel.isClientSide) {
            GrayFlareProjectile projectile = new GrayFlareProjectile(pLevel, pPlayer);
