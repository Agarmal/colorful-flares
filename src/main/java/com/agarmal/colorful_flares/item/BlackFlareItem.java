...
public class BlackFlareItem extends Item {
    public BlackFlareItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if (!pLevel.isClientSide) {
            BlackFlareProjectile projectile = new BlackFlareProjectile(pLevel, pPlayer);
